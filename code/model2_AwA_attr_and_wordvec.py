...
def test_acc_fe(model):
    ...
    y_pred = model.predict(test_word_per_class)
...
if __name__ == '__main__':
    ...
    model = dem(train_word.shape[1], x.shape[1], norm_rate=1e-3)
    ...
    model.summary()
    model.fit(x=train_word, y=x, batch_size=1024, epochs=100000, callbacks=callback_lists,
              shuffle=True)
